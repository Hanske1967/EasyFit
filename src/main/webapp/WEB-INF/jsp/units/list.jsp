...
<div class="container">
    ...
    <a class="btn btn-primary pull-right" href="./edit"><fmt:message key="units.list.newUnit"/></a>

    <table class="table table-hover">
        <thead>
        <tr class="th">
            <th><fmt:message key="units.list.name"/></th>
            <th><fmt:message key="units.list.description"/></th>
            <th><fmt:message key="units.list.action"/></th>
        </tr>
        </thead>
        <tbody>
