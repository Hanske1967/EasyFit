        ...
        <form:form id="form" method="post" modelAttribute="consumptionDetailForm" action="./adddetail3?">
            <fieldset>
                ...
                <form:label path="amount">
                    <fmt:message key="consumptions.editdetail.amount"/><form:errors path="amount" cssClass="error"/>
                </form:label>
                ...
                <label><fmt:message key="consumptions.editdetail.points"/></label>
                <input id="points" type="text" placeholder="points"/>

                <p class="text-info">${consumptionDetailForm.product.pointsLabel} <fmt:message key="consumptions.list.pts"/>
